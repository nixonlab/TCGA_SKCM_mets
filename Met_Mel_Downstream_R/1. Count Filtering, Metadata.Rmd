...
### 1. Selected samples with complete metadata for unsupervised clustering                                                        
...
### 2. Metadata for responder vs. non-responder
...
# Data Saving
```{r, eval = FALSE}
save(metadata, mets_selected, te_annot, gene_annot,response_samples, raw_gene, raw_herv, hugo_metadata, hugo_gene, hugo_herv, make_sum, retro.family.table,file = "/Users/phoebefei/Desktop/WCM/Mets Melanoma/TCGA SKCM/RData/1.count_data.RData")
```
